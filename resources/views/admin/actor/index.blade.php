...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div>
            <a href="{{ route('admin.actors.create') }}" class="btn btn-danger btn-sm">
        ...
        <table class="table table-hover table-striped">
            ...
            @foreach($objs as $obj)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('admin.actors.edit', $obj->id) }}" class="btn btn-success btn-sm my-1">
                            <i class="bi-pencil"></i>
                        </a>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <form action="{{ route('admin.actors.destroy', $obj->id) }}" method="post">
                                            @method('DELETE')
                                            @csrf
                                            @honeypot
